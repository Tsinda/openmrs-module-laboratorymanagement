...
public class LaboratoryDAOimpl implements LaboratoryDAO {
	 ...
	 * get all Lab obs
	 * 
	 * @see org.openmrs.module.laboratorymanagement.db.LaboratoryDAO#getLabExamsByExamType(int,
	...
	public List<Order> getLabOrders(int patientId, Collection<Integer> cptIds,
		...
		strbuf.append("  " + " and  cast(o.date_activated as date) =  '"
				+ df.format(startDate) + "'");
		query = sessionFactory.getCurrentSession().createSQLQuery(
				strbuf.toString());
	...
	/**
	 * @see org.openmrs.module.laboratorymanagement.db.LaboratoryDAO#getPatientLabordersBetweendates(int,
	...
	/**
	 * @see org.openmrs.module.laboratorymanagement.db.LaboratoryDAO#getObsByLabCode(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see org.openmrs.module.laboratorymanagement.db.LaboratoryDAO#getObsByLabOrder(org.openmrs.Order,
	 *      org.openmrs.Concept)
	 */
	@Override
